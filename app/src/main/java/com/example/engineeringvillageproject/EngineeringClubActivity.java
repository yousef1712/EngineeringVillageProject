...
public class EngineeringClubActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_engineering_club);
        ...
        i = new Intent(EngineeringClubActivity.this, LoginActivity.class);
